...
def add_default_course():
    ...
    price='1500 руб. / 3 часа'
    )

    service = Course(
        name='Коворкинг для художников',
        avatar='/static/images/gallery/coworking.jpeg',
        description='Аренда рабочего места для художников в центре Петербурга. Наша студия предлагает вам коворкинг, где вы сможете самостоятельно заниматься созданием вашего произведения искусства. Есть возможность разместиться в большой мастерской в творческой компании среди единомышленников или уединиться со своей работой в маленькой уютной комнате. Это прекрасная возможность творить в обустроенных под мастерские помещениях, а рабочая атмосфера будет способствовать вдохновению и творчеству.',
        price='500 руб. / час'
    )
...
def add_default_teacher():
    ...
    teacher_3 = Teacher(
        avatar='/static/images/gallery/LinShiyao.jpeg',
        name='Линь Шияо (Lin Shiyao)',
        about="""<div>
<p>Художник-монументалист<br>
Член Китайской ассоциации настенных росписей (China Mural Association).</p>

<p>Постдокторант Центральной академии художеств (Central Academy of Fine Arts).</p>

<p>В настоящее время работает в Китайской академии культурного наследия (China Academy of Cultural Heritage).</p>

<p>Окончила Акдемию художеств им. Репина( мастерская Репина С.Н.)<br>
В 2020 окончила асперантуру Академии Художеств им. Репина</p>
</div>"""
    )
